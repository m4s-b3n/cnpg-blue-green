...
**YOU ARE IN: `cnpg_blue_green/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/cnpg_blue_green/` (rig root) or other directories
...
**Your mail address:** `cnpg_blue_green/polecats/chrome`
**Your rig:** cnpg_blue_green
**Your Witness:** `cnpg_blue_green/witness`
...
| Ask Witness for help | `gt mail send cnpg_blue_green/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`cnpg_blue_green/witness`) when:
...
```bash
gt mail send cnpg_blue_green/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
